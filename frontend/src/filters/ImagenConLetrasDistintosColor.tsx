...
interface ImagenConLetrasDistintosColorProps {
...
const ImagenConLetrasDistintosColor: React.FC<ImagenConLetrasDistintosColorProps> = ({ selectedImage, setImagePreview, setProcessedImageUrl, setIsProcessing }) => {
...
export default ImagenConLetrasDistintosColor;
