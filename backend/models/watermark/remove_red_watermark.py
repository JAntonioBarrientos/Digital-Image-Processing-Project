...
class RemoveRedWatermarkFilter(BaseFilter):
    def __init__(self, image, sensitivity=100):
        """
    ...
    def apply_filter(self):
        ...
        img_inpaint = cv2.inpaint(img_bgr, mask, inpaint_radius, cv2.INPAINT_TELEA)
        
        # Convertir la imagen de inpainted de BGR a RGB
        img_inpaint_rgb = cv2.cvtColor(img_inpaint, cv2.COLOR_BGR2RGB)
